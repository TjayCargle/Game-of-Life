...
Game_BattlerBase.prototype.skillTpGain = function(skill) {
  var amount = skill.tpGain;
  var item = skill;
  var a = this;
  var user = this;
  var subject = this;
  var s = $gameSwitches._data;
  var v = $gameVariables._data;
  // += this.maxTp() * skill.tpCostPer;
  eval(skill.tpCostEval);
  return Math.max(0, Math.floor(amount));
};


Game_BattlerBase.prototype.skillUpgrade = function(skill1,skill2) {
  var item1 = skill1;
  var item2 = skill2
  var a = this;
  var user = this;
