...
Yanfly.Item.Game_BattlerBase_mSC =
    Game_BattlerBase.prototype.meetsItemConditions;
Game_BattlerBase.prototype.meetsItemConditions = function(item) {
    if (!Yanfly.Item.Game_BattlerBase_mSC.call(this, item)) return false;
    if (!item) return false;
    return this.meetsItemConditionsEval(item);
};
Game_BattlerBase.prototype.meetsItemConditionsEval = function(_item) {
    if (_item.requireEval === '') return true;
    var value = true;
    var item = _item;
    var a = this;
    var user = this;
    ...
    eval(_item.requireEval);
    return value;
};

Yanfly.Item.Game_BattlerBase_consumeItem =
    Game_Battler.prototype.consumeItem;
Game_Battler.prototype.consumeItem = function(item) {
    Yanfly.Item.Game_BattlerBase_consumeItem.call(this, item);
   this.payItemEvalCost(item);
};


Game_BattlerBase.prototype.payItemEvalCost = function(_item) {
    if (_item.executeEval === '') return;
    var item = _item;
    var a = this;
    var user = this;
    var subject = this;
