...
DataManager.processARSNotetags1 = function(group) {
    ...
    for (var i = 0; i < notedata.length; i++) {
        ...
        obj.baseArmorScale = '';
			...
			} else if (line.match(/<(?:ARMOR REDUCTION):[ ](\d+)([%ï¼…])>/i)) {
			...
			} else if (line.match(/<(?:ARMOR PENETRATION):[ ](\d+)([%ï¼…])>/i)) {
...
DataManager.processARSNotetags2 = function(group) {
	...
	var note02 = /<(?:PHYSICAL ARMOR REDUCTION):[ ](\d+)([%ï¼…])>/i;
	var note03 = /<(?:PHYSICAL ARMOR PENETRATION):[ ](\d+)([%ï¼…])>/i;
	var note04 = /<(?:PHYSICAL ARMOR PENETRATION):[ ](\d+)>/i;
	var note05 = /<(?:MAGICAL ARMOR REDUCTION):[ ](\d+)>/i;
	var note06 = /<(?:MAGICAL ARMOR REDUCTION):[ ](\d+)([%ï¼…])>/i;
	var note07 = /<(?:MAGICAL ARMOR PENETRATION):[ ](\d+)([%ï¼…])>/i;
	var note08 = /<(?:MAGICAL ARMOR PENETRATION):[ ](\d+)>/i;
	var note09 = /<(?:CERTAIN ARMOR REDUCTION):[ ](\d+)>/i;
	var note10 = /<(?:CERTAIN ARMOR REDUCTION):[ ](\d+)([%ï¼…])>/i;
	var note11 = /<(?:CERTAIN ARMOR PENETRATION):[ ](\d+)([%ï¼…])>/i;
